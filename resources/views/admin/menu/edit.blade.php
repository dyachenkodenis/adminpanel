    ...
    <div class="container-fluid px-4">
        ...
        <ol class="breadcrumb mb-4 mt-4">
            <li class="breadcrumb-item active">
              <a href="{{ route('admin.menu.index') }}" title="Go back">Назад к списку страниц</a>
            </li>
        </ol>
        @if (session('update'))
             <div class="col-md-12">
            ...
            <div class="tab-content pt-2" id="tab-content">
                 ...
                 <div class="tab-pane " id="setting_panel" role="tabpanel" aria-labelledby="setting">
                    ...
                    <div class="col-md-12 m-2">
                        <label for="menu_name" class="form-label">Название страницы</label>
                        <input type="text" value="{{ $menu->title }}" name="menu_name" class="form-control" id="menu_name">
                    ...
                    <div class="col-md-12 m-2">
                            <label for="menu_template" class="form-label">Шаблон страницы</label>
            ...
            <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
               ...
               <script>
                ...
                window.onload = function(){
                                    ...
                                    @if(isset($menu->jsonvalue) && $menu->jsonvalue)
                                        @php
                                        echo 'var data_json ='.json_encode($menu->jsonvalue);
                                        @endphp
                        ...
                        document.querySelector('#save').addEventListener('click', alldata);
                                        ...
                                        {
                                          //  console.log(getData());
                                            fetch("{{ route('admin.menu.update', $menu->id) }}", {
                                                method: "POST",
                                                headers: {
